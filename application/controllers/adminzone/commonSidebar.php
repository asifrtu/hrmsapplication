	...
	background-color: #6f42c1;	
        ...
        <ul class="navbar-nav sidebar sidebar-dark" id="accordionSidebar">
            ...
            <li class="nav-item">
				...
				<a class="nav-link empCH collapsed" style=" color:yellow!important; border-top: 1px solid #2e2869;" href="<?=base_url('index.php/adminzone/EmployeeAttendance/applyLeave');?>" >
            ...
            <li class="nav-item">
                <a class="nav-link empCH collapsed" href="<?=base_url('index.php/adminzone/EmployeeInfo/Goals');?>" >
