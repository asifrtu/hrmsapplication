                ...
                <div class="container-fluid">
					...
					<!-- Area Chart -->
						...
						<div class="">	
								...
								<?php echo form_open_multipart('adminzone/Separation/AddSepSecond'); ?>
									...
									<table class="table table-bordered" id="TimelistdataTable" width="100%">
										...
										<tbody>
											<tr>
												...
												<td style="min-width: 120px!important;"><input type="text" name="IRAName" class="form-control"></td>
												<td style="min-width: 120px!important;">IRA Emp. Code</td>
												<td style="min-width: 120px!important;"><input type="text" name="IRAEmpCode" class="form-control"></td>
											...
											<tr>
												...
												<td style="min-width: 120px!important;"><input type="text" name="IRADesignation" class="form-control"></td>
									...
									<table class="table table-bordered" id="TimelistdataTable" width="100%">
										...
										<tbody>
											<tr>
												...
												<td style="min-width: 120px!important;"><input type="text" name="HODName" class="form-control"></td>
												<td style="min-width: 120px!important;">HOD Emp. Code</td>
												<td style="min-width: 120px!important;"><input type="text" name="HODEmpCode" class="form-control"></td>
											...
											<tr>
												...
												<td style="min-width: 120px!important;"><input type="text" name="HODDesignation" class="form-control"></td>
										...
										<tbody>
											<tr>
												...
												<td style="min-width: 120px!important;">
													...
													<input type="radio" class="form-check-input" name="NoticePeriodServed" value="1">Yes
													</label>
													</div>
													</div>
													<div class="col-lg-6">
													<div class="form-check-inline">
													<label class="form-check-label">
													<input type="radio" class="form-check-input" name="NoticePeriodServed" value="0">No
													</label>
													</div>
													</div>
													</div>
												...
												<td style="min-width: 120px!important;">
													...
													<input type="text" name="NoticePeriodDeductdays" class="form-control">
												...
												<td style="min-width: 120px!important;">
													...
													<input type="text" name="LeavesinexitMonth" class="form-control">
												...
												<td style="min-width: 120px!important;">
													...
													<div class="form-check-inline">
													<label class="form-check-label">
													<input type="radio" class="form-check-input" name="ReleasingFullAndFinalSettlement" value="1">Yes
													</label>
													</div>
													</div>
													<div class="col-lg-6">
													<div class="form-check-inline">
													<label class="form-check-label">
													<input type="radio" class="form-check-input" name="ReleasingFullAndFinalSettlement" value="0">No
													</label>
													</div>
													</div>
													</div>
												...
												<td style="min-width: 120px!important;">
													...
													<div class="form-check-inline">
													<label class="form-check-label">
													<input type="radio" class="form-check-input" name="IssuingRelevingLetter" value="1">Yes
													</label>
													</div>
													</div>
													<div class="col-lg-6">
													<div class="form-check-inline">
													<label class="form-check-label">
													<input type="radio" class="form-check-input" name="IssuingRelevingLetter" value="0">No
													</label>
													</div>
													</div>
													</div>
								...
								<div class="col-lg-3">
									...
									<input type="text" name="FromReceivedOn" class="form-control">
								...
								<div class="col-lg-3">
									...
									<input type="text" name="DOL" class="form-control">
										...
										<tbody>
											<tr>
												...
												<td style="min-width: 120px!important;">
													...
													<div class="form-check-inline">
													<label class="form-check-label">
													<input type="radio" class="form-check-input" name="payrollNoticePeriodServed" value="1">Yes
													</label>
													</div>
													</div>
													<div class="col-lg-6">
													<div class="form-check-inline">
													<label class="form-check-label">
													<input type="radio" class="form-check-input" name="payrollNoticePeriodServed" value="0">No
													</label>
													</div>
													</div>
													</div>
												...
												<td style="min-width: 120px!important;">
													...
													<input type="text" name="payrollNoticePeriodDeductdays" class="form-control">
												...
												<td style="min-width: 120px!important;">
													...
													<input type="text" name="payrollLeavesinexitMonth" class="form-control">
												...
												<td style="min-width: 120px!important;">
													...
													<div class="form-check-inline">
													<label class="form-check-label">
													<input type="radio" class="form-check-input" name="payrollExitMark" value="1">Yes
													</label>
													</div>
													</div>
													<div class="col-lg-6">
													<div class="form-check-inline">
													<label class="form-check-label">
													<input type="radio" class="form-check-input" name="payrollExitMark" value="0">Yes
													</label>
													</div>
													</div>
													</div>
												...
												<td style="min-width: 80px!important;">
													...
													<div class="form-check-inline">
													<label class="form-check-label">
													<input type="radio" class="form-check-input" name="payrollHandoverOfJobResponsibilities" value="1">Yes
													</label>
													</div>
													</div>
													<div class="col-lg-6">
													<div class="form-check-inline">
													<label class="form-check-label">
													<input type="radio" class="form-check-input" name="payrollHandoverOfJobResponsibilities" value="0">Yes
													</label>
													</div>
													</div>
													</div>
								...
								<div class="col-lg-3">
									...
									<input type="text" name="HREmpCode" class="form-control">
