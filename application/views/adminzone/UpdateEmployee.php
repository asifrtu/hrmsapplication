  ...
  .ColorPrimary h5{
      margin-bottom:0.2rem!important;
			...
			if(!empty($this->session->flashdata('message'))) { ?>
                ...
                <?php } ?>
        <!-- Content Wrapper -->
        <div id="content-wrapper bg-gradient-primary" class=" my_information col-lg-10" style="margin-bottom:50px;">
                ...
                <div class="">
                    ...
                    <!-- Content Row -->
					  <!-- Area Chart -->
						...
						<?php echo form_open_multipart('adminzone/EmployeeInfo/UpdateEmployeeQdx'); ?>
								...
								<div class="card-body">
										...
										<div class="card-header Aqdx col-lg-12 ColorSecondary">
											<ul class="AUemp">
											<li class="Aemp"><a href="#">Education Qualification&nbsp;&nbsp;<span><small>|&nbsp;&nbsp; (Please Fill the Education Qualification Details.)</small></span></a></li>
