                ...
                <div class="">
					...
					<!-- Area Chart -->
						...
						<h6 class="m-0 font-weight-bold ColorPrimary" style="padding:5px;"><?php if(!empty($Title->title_78)){echo $Title->title_78;} ?></h6>
							...
							<li class="page-item active" ><a class="page-link" href="<?=base_url('index.php/adminzone/Appraisal/AppraisalForm');?>">1</a></li>
							...
							<li class="page-item"><a class="page-link" href="<?=base_url('index.php/adminzone/Appraisal/AppraisalFormTwo');?>">Next</a></li>
							</ul>
...
<!-- Modal content-->
	...
	<form class="form-horizontal" action="#">
			...
			<div class="col-lg-9">
			<div class="form-group">
			<input type="text" name="CL_Status" id="AppraisalTitle" class="empInput form-control" style="border: 1px solid #858796;">
			</div>
			</div>
...
<script>
	...
	var ajaxurl = "<?=site_url('adminzone/Appraisal/AppraisalView');?>";
        $.ajax({
            type: "get",
            url: ajaxurl,
            data: {id:id},
  ...
  // function updateUserRecord(){
	...
	var ajaxurl = "<?=site_url('adminzone/Appraisal/UpadteTitle');?>";
        $.ajax({
            type: "post",
            url: ajaxurl,
            data: {Title : Title},
