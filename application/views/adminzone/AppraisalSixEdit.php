                ...
                <div class="container-fluid">
					...
					<!-- Area Chart -->
						...
						<div class="">	
								...
								<?php echo form_open_multipart('adminzone/Appraisal/AppraisalSix'); ?>
									...
									<table class="table table-bordered" id="TimelistdataTable" width="100%">
										...
										<thead>
											...
											<tr style="background-color:#f3f3f7;">
												...
												<th class="" style="color:black;"><?php if(!empty($Title->title_67)){echo $Title->title_71;} ?></th>
												<th class="" style="color:black;"><?php if(!empty($Title->title_67)){echo $Title->title_72;} ?></th>
												<th class="" style="color:black;"><?php if(!empty($Title->title_67)){echo $Title->title_73;} ?></th>
												<th class="" style="color:black;"><?php if(!empty($Title->title_67)){echo $Title->title_74;} ?></th>
										...
										<tbody>
											...
											<?php if(!empty($ExiTSix)):  ?>
									
											<?php	
											
											
											foreach($ExiTSix as $emp): ?>
											<tr>
												
												<td ><input type="text" class="form-control" name="Goal[]" value="<?php if(isset($emp->Goal)) echo $emp->Goal;?>" ></td>
												<td ><input type="text" class="form-control" name="ExpectedOutcomeMeasurableCriteria[]" value="<?php if(isset($emp->ExpectedOutcomeMeasurableCriteria)) echo $emp->ExpectedOutcomeMeasurableCriteria;?>" ></td>
												<td ><input type="text" class="form-control" name="TimeTable[]" value="<?php if(isset($emp->TimeTable)) echo $emp->TimeTable;?>" ></td>
												<td ><input type="text" class="form-control" name="IssueOrComments[]" value="<?php if(isset($emp->IssueOrComments)) echo $emp->IssueOrComments;?>" ></td>
										...
										<tbody>
											<tr>
												...
												<td colspan="4"><textarea class="form-control" name="OverallComments" rows="2"><?php if(!empty($ExiTSixComment->OverallComments)):?><?php  echo $ExiTSixComment->OverallComments; ?> <?php endif; ?></textarea></td>
							...
							<li class="page-item"><a class="page-link" href="<?=base_url('index.php/adminzone/Appraisal/AppraisalFormFive');?>">Previous</a></li>
							...
							<li class="page-item active"><a class="page-link" href="<?=base_url('index.php/adminzone/Appraisal/AppraisalFormSix');?>">6</a></li>
							</ul>
