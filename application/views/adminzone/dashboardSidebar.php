                ...
                <div class="text-center card-box" style="margin-top: 0px;">
					...
					<a href="#" data-toggle="modal" data-target="#myModal" style="text-decoration:none;"><i class="fa fa-camera upload-button"></i></a>
						...
						<div class="" style="margin-top: 145px;">
                            ...
                            <p class="text-muted"><span><a href="#" class="text-pink" style="text-decoration: none;" style="font-size:15px;"><?php if (!empty($EmployeeDetails->position)) {
						echo $EmployeeDetails->position;
					} ?></a></span></p>
                            <p class="emp_Id"><?php echo $UserInfo->employee_id; ?><br><?php $UserInfo->id; ?></p>
                        </div>
