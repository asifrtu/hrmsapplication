    ...
    padding: 0.3rem 1.25rem!important ;}
        ...
        <div id="content-wrapper bg-gradient-primary" class="container-fluid col-lg-10" style="margin-bottom:50px; margin-top:30px; padding-left:10px;">
          ...
          <div class="card-header ColorSecondaryPre">
						...
						<div class="col-lg-7"> <i style="font-size: 10px;color: white;" class="fas fa-chevron-right"></i>&nbsp;<span class="breadcrumb_text"  style="font-size: 15px;color: #fff; font-weight:600;"> Files &nbsp;</span>&nbsp;</div>
              ...
              <button class="btnQdUpload"><i class="fas fa-folder-open"></i></button>  
										...
										<thead>
											<tr>
												...
												<th colspan="1" class="cmPayroll">
													<span class="actionFile"><a href="#">Action</a></span>
