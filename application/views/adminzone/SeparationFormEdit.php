                ...
                <div class="container-fluid">
					...
					<!-- Area Chart -->
						...
						<div class="">	
								...
								<?php echo form_open_multipart('adminzone/Separation/FormOneEdit'); ?>
									...
									<table class="table table-bordered" id="TimelistdataTable" width="100%">
										...
										<tbody>
											...
											<tr>
												...
												<td style="min-width: 120px!important;">Joining Date</td>
												<td style="min-width: 120px!important;"></td>
												<td style="min-width: 120px!important;">Relieving Date</td>
												<td style="min-width: 120px!important;"></td>
										...
										<tbody>
											<tr>
												...
												<div class="row" style="margin:0px!important;">
													...
													<input type="checkbox" class="form-check-input" name="pf_status" value="Yes" <?php if($ProvidentFund->pf_status == "Yes") echo "checked";?>>Yes
													</label>
													</div>
													</div>
													<div class="col-lg-6">
													<div class="form-check-inline">
													<label class="form-check-label">
													<input type="checkbox" class="form-check-input" name="pf_status" value="No" <?php if($ProvidentFund->pf_status == "No") echo "checked";?>>No
													</label>
													</div>
													</div>
													</div>
