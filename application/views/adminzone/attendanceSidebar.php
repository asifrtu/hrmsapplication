...
.style-8::-webkit-scrollbar-thumb
{
	background-color: #6f42c1;	
        ...
        <ul class="navbar-nav sidebar sidebar-dark" id="accordionSidebar">
			...
			<li class="nav-item">
                <a class="active nav-link empCH collapsed" href="<?=base_url('index.php/adminzone/EmployeeAttendance/myAttendance');?>" >
            ...
            <li class="nav-item">
                <a class="nav-link empCH collapsed" href="<?=base_url('index.php/adminzone/EmployeeAttendance/EmployeeApplyLeave');?>" >
            ...
            <li class="nav-item">
                <a class="nav-link empCH collapsed" href="<?=base_url('index.php/adminzone/EventController');?>" >
