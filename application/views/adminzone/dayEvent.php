...
<?php
			...
			if(!empty($this->session->flashdata('message'))) { ?>
                ...
                <?php } ?>
                    ...
                    <!-- Content Row -->
					  <!-- Area Chart -->
                      <div class="d-flex justify-content-between employee_details">
						<div class="" style="color:white; margin-top: 6px;"><h6>Day Event</h6>
						<span >Click on <strong>"Date"</strong> Add New Event.</span>
					</div>
						<div>
						<div class="fc-button-group calander_shift"><button type="button" class="fc-agendaDay-button fc-button fc-state-active" onclick="javascript:location.href='<?=base_url('index.php/adminzone/EventController/Day');?>'">Day</button><button type="button" class="fc-agendaWeek-button fc-button fc-state-default" onclick="javascript:location.href='<?=base_url('index.php/adminzone/EventController/WeekInfo');?>'">Week</button><button type="button" class="fc-month-button fc-button fc-state-default fc-state-default" onclick="javascript:location.href='<?=base_url('index.php/adminzone/EventController/');?>'">Month</button><button type="button" class="fc-year-button fc-button fc-state-default fc-state-hover" onclick="javascript:location.href='<?=base_url('index.php/adminzone/EventController/YearlyEvents');?>'">Year</button></div>
