            ...
            <div id="content">
				...
				<div class="">
					...
					<div class="shadow ">
						...
						<div class="employee_details" style="padding: 9px 5px 5px 16px;">
						<h5 class=" md-4 ColorPrimary" style="font-size:15px;;margin-top: 8px;">Team Goals</h5>
							<div style="margin-right: 6px;">
									
									<select class=" AttSort form-control" name="Year_Id" id="SeoYear_Id" style="border: 1px solid #858796;" id="sel1">
					  ...
					  <!-- Area Chart -->
								...
								<div class="card-body">
									...
									<div class="table-responsive">
										<table class="table mt-4" id="SeodataTable"  cellspacing="0">
...
<div class="card-body col-lg-12 mt-4">
        ...
        $.ajax({
			...
			if(response)
				$("#SeodataTable tbody").html(`${response.data.map(function(data, index){
					...
					<td class="AttFontStatus ${data.work_status}">${data.work_status}</td>
