                ...
                <div class="container-fluid">
					...
					<!-- Area Chart -->
						...
						<h6 class="m-0 font-weight-bold ColorPrimary" style="padding:5px;"><?php if(!empty($Title->title_79)){echo $Title->title_79;} ?></h6>
							...
							<li class="page-item"><a class="page-link" href="<?=base_url('index.php/adminzone/Appraisal/AppraisalForm');?>">Previous</a></li>
							<li class="page-item " ><a class="page-link" href="<?=base_url('index.php/adminzone/Appraisal/AppraisalForm');?>">1</a></li>
							<li class="page-item active"><a class="page-link" href="<?=base_url('index.php/adminzone/Appraisal/AppraisalFormTwo');?>">2</a></li>
							...
							<li class="page-item"><a class="page-link" href="<?=base_url('index.php/adminzone/Appraisal/AppraisalFormThree');?>">Next</a></li>
							</ul>
