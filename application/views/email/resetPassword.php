												...
												<tr>
													<td style="padding:17px 3.358% 15px">
														<cite style="text-align:center;display:block;font-style:normal">
															<span style="font-size:1px;min-height:0;color:#fff;width:0;display:block"></span>
															<dl style="list-style-type:none;padding:0;overflow:hidden;margin:0">
																<dt style="font-size:15px;display:inline-block;width:100%;margin:0;padding:0 0 12px 0;vertical-align:top;padding-bottom:0!important">
																	<a href="https://www.COMPANY_DOMAIN/" title="iwantthis" style="display:inline-block" target="_blank"><?php echo COMPANY_DOMAIN; ?>/a>
																</dt>
																	...
																	<tr>
																		<td align="center">
																			<div style="width:100%">
																				...
																				<b>Hi, <?php echo $data1["email"]; ?></b><br><br><span class="il"><?php echo $data1["message"]; ?></span><br><br><span class="il"><?php echo $data1["temp_password"]; ?></span>
																				<p>Click the <b>Reset Password Link</b> below to reset the password for your account:</p>
																				<div style="min-height:20px"></div>
																				<div style="width:100%">
																					<a style="display:inline-block;font-size:15px;padding:10px 18px;vertical-align:middle;color:#ffffff;background:#FF6347;border-top:solid 1px #FFFFFF;border-right:solid 1px #FFFFFF;border-bottom:solid 1px #FFFFFF;border-left:solid 1px #FFFFFF;border-radius:3px;text-decoration:none;white-space:normal;font-weight:bold;line-height:18px" href="<?php echo $data1['reset_link']; ?>" target="_blank"> <span class="il"> Reset Password Link </span></a>
																				</div>
																				...
																				<p style="text-align:center;">If you did not request to reset your password, ignore this email! </p>
														</div>
													</td>
												</tr>
											</tbody>
