...
<div class="col-lg-7"> <i style="font-size: 10px;color: white;" class="fas fa-chevron-right"></i><a href="<?php echo base_url() ?>index.php/hrzone/CompanyGoals/designerGoalView" style="text-decoration:none;"><span class="breadcrumb_text" style="font-size: 15px;color: #fff;"> &nbsp;view&nbsp;&nbsp;</span></a><i style="font-size: 10px;color: white;" class="fas fa-chevron-right"></i><span class="breadcrumb_text" style="font-size: 15px;color: #fff;"> &nbsp;Designer Team Goals - <span style="font-weight:bold;">edit </span></span></div>
                        </div>
 </div>
					

						<?php echo form_open_multipart('hrzone/CompanyGoals/DesignerGoalsUpdate'); ?>
								...
								<div class="card-body">
										...
										<label>Goals List for Designer Team</label>
