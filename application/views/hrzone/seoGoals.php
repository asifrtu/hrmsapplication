                    ...
                    <!-- Content Row -->
					  <!-- Area Chart -->
							...
							<div class="col-lg-12">
								...
								<div class="col-lg-4" >
								<div class="row">
								<h5 style="text-align:center; margin:auto; color:#6f42c1; font-weight:700;">Seo Team Goals</h5>
								</div>
								</div>
								<div class="col-lg-4" >
								</div>
							...
							<div class="card-body">
								...
								<div class="col-lg-4" >
								<div class="row">
								<h5 style="text-align:center; margin:auto; color:#6f42c1; font-weight:700;">Monthly Goals for SEO Team</h5>
								</div>
								</div>
								<div class="col-lg-4" >
								</div>
									...
									<h5 style="margin-right: 80px; color:#6f42c1; font-weight:700;">Monthly Goals for SEO Team</h5>
									</div>
									<div class="table-responsive">
			...
			if(response)
				$("#CompanydataTable tbody").html(`${response.data.map(function(data, index){
					...
					<td>
						<div class=" ">
						<ul class="tnUemp">
						<li class="tnemp"><a href="javascript:void(0)" data-yearD="${data.goalpoints_Id}" class="CompanyData"><i class="actionFontSize fas fa-trash-alt"></i></a></li>
