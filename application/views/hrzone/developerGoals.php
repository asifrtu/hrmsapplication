					  ...
					  <!-- Area Chart -->
							...
							<div class="col-lg-12">
								<div class="tableHeadAR">
									<h6 class="m-0 font-weight-bold ColorPrimary" style="margin:15px 0;">Yearly Developer Team Goals</h6>
								</div>
							</div>
							</div>
								...
								<div class="col-lg-4" >
								<div class="row">
								<h5 style="text-align:center; margin:auto; color:#6f42c1; font-weight:700;">Yearly Developer Team Goals</h5>
								</div>
								</div>
								<div class="col-lg-4" >
								</div>
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="tableHeadAR">
									<h6 class="m-0 font-weight-bold ColorPrimary" style="margin:15px 0;">Monthly Developer Team Goals</h6>
								</div>
							</div>
							</div>
                    ...
                    <!-- Content Row -->
					  <!-- Area Chart -->
								...
								<div class="p-2 bg-info" style="margin-left:5px;">
									...
									<h5 style="margin-right: 70px; color:#6f42c1; font-weight:700;">Monthly Developer Team Goals</h5>
...
<script>
	...
	$(document).ready(function(){
		...
		$("body").on('click', '.DeveloperCompanyEdit', function(){
  ...
  $("body").on('click', '.CompanyGoalsDelete', function(){
    var conf = 'Are you sure You have to delete this file';
	var id = $(this).attr('data-CGID');
	var Yid = $("#Year_Id").val();
...
$("body").on('click', '.CompanyGoalSub', function(){
  // function updateUserRecord(){
        ...
        $.ajax({
			...
			if(response)
				$("#CompanydataTable tbody").html(`${response.data.map(function(data, index){
					...
					<td><div class=" ">
													<ul class="tnUemp">
													<li class="tnemp"><a href="javascript:void(0)" data-CGID="${data.goalpoints_Id}" class="CompanyGoalsDelete"><i class="actionFontSize fas fa-trash-alt"></i></a></li>
													<li class="tnemp"><a href="javascript:void(0)" data-yearD="${data.goalpoints_Id}" class="DeveloperCompanyEdit"><i class="actionFontSize fas fa-edit"></i></a></li>
													</ul>
...
function SeoYearlyGoal(YearID){
	var ajaxurl = "<?=site_url('hrzone/CompanyGoals/DeveloperGoalPointsByYear');?>";
        $.ajax({
            type: "get",
            url: ajaxurl,
            data: { YearID : YearID},
