  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="card-header" style="padding:7px!important; background-color: #1C304C;">
			...
			<button style="/* margin-left:197px; */"class="close" data-bs-dismiss="modal">×</button>
			</div>
			</div>
 ...
 <form  id="kpiform" method="POST" name="kpiform" action="">			
  ...
  <thead>
	   ...
	   <div class="d-flex flex-row-reverse " style="margin-bottom:10px;background:#9e94ab;">
		...
		<h5 style="padding-top:5px; padding-left:15px; color: white!important; font-weight:500; font-size: 16px; ">Click on <span style="color:#fff!important;">"+"</span>icon to <span style="color:white!important;"><strong>Add New Row.</strong></span><a href="#" id="add-Education" style="padding-left: 13px;"><span style="color:red;">"+"</span></a></h5>
			...
			if(response)
				$("#KPITeamRenderHtml tbody").html(`${response.data.map(function(data, index){
					return(`<tr>
										...
										<td style="min-width: 15px!important; text-align:center; padding: 0.25rem!important;" class="AttFontStatus edit_Attn ${KPIMonthlyMarksData.marksObt}">${(KPIMonthlyMarksData.marksObt != "")?KPIMonthlyMarksData.marksObt: "Nil"}</td>
