                ...
                <div class="container-fluid">
					...
					<!-- Area Chart -->
						...
						<h6 class="m-0 font-weight-bold ColorPrimary" style="padding:5px;"><?php if(!empty($Title->title_78)){echo $Title->title_78;} ?></h6>
							...
							<li class="page-item active" ><a class="page-link" href="<?=base_url('index.php/hrzone/Appraisal/AppraisalForm/'.$UserId);?>">1</a></li>
							...
							<li class="page-item"><a class="page-link" href="<?=base_url('index.php/hrzone/Appraisal/AppraisalFormFour/'.$UserId);?>">4</a></li>
							<li class="page-item"><a class="page-link" href="<?=base_url('index.php/hrzone/Appraisal/AppraisalFormFive/'.$UserId);?>">5</a></li>
							<li class="page-item"><a class="page-link" href="<?=base_url('index.php/hrzone/Appraisal/AppraisalFormSix/'.$UserId);?>">6</a></li>
							<li class="page-item"><a class="page-link" href="<?=base_url('index.php/hrzone/Appraisal/AppraisalFormTwo/'.$UserId);?>">Next</a></li>
							</ul>
