...
<div class="col-lg-7"> <i style="font-size: 10px;color: white;" class="fas fa-chevron-right"></i><span class="breadcrumb_text" style="font-size: 15px;color: #fff;"> &nbsp;SEO Team Goals - <span style="font-weight:bold;">view </span></span></div>
                    ...
                    <!-- Content Row -->
					  <!-- Area Chart -->
								...
								<div class="card-body">
									...
									<div class="p-2 bg-info" style="margin-right:5px;">
									...
									<div class="table-responsive">
										<table class="table table-bordered table-sm" id="SeodataTable" width="100%" cellspacing="0">
											...
											<tr>
												...
												<th class="cmPayroll">Goals List for SEO Team</th>
												<th class="cmPayroll">Comment</th>
												<th style="width:50px;" class="cmPayroll">Status</th>
...
<!-- Modal content-->
	...
	<div class="card-header" style="padding:7px!important; background-color: #1C304C;">
			<div class="">
			<h6 class="ColorPrimary" style="text-align: center;margin-bottom: 0px;">SEO Goals's Edit</h6>
...
function SeoYearlyGoal(YearID){
	var ajaxurl = "<?=site_url('hrzone/CompanyGoals/SeoGoalPointsByYear');?>";
        $.ajax({
            type: "get",
            url: ajaxurl,
            data: {YearID : YearID},
			...
			<a href="<?=site_url('hrzone/CompanyGoals/SeoGoalsEdit');?>/${YearempIDData}" style="color: #7481a5; text-decoration: none;">Edit</a>
