...
.card-body {
 ...
 <div id="content-wrapper bg-gradient-primary" class="d-flex flex-column" style="margin-top:0px; margin-bottom:50px;">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
					...
					<div class="card shadow mb-4" style="width:900px; margin-bottom:100px;">
                            ...
                            <h5 class=" md-4 ColorPrimary" style="font-size:17px;">Team KPI</h5>
                        </div>
					  ...
					  <!-- Area Chart -->
							...
							<div class="card-body">
								...
								<div class="p-2 bg-info" style="margin-left:5px;">
									...
									<h5 style="text-align:center; margin:auto; color:#6f42c1; font-weight:500; font-size: 18px;">Team KPI</h5>
									</div>
...
function EmployeeKPITeam(PositionID, MonthID, YearID){
