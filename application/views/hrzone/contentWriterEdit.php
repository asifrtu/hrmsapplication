...
<div class="col-lg-7"> <i style="font-size: 10px;color: white;" class="fas fa-chevron-right"></i><a href="<?php echo base_url() ?>index.php/hrzone/CompanyGoals/contentWriterGoalView" style="text-decoration:none;"><span class="breadcrumb_text" style="font-size: 15px;color: #fff;"> &nbsp;view&nbsp;&nbsp;</span></a><i style="font-size: 10px;color: white;" class="fas fa-chevron-right"></i><span class="breadcrumb_text" style="font-size: 15px;color: #fff;"> &nbsp;Content Writer Goals - <span style="font-weight:bold;">edit </span></span></div>
                        </div>
 </div>
						...
						<?php echo form_open_multipart('hrzone/CompanyGoals/ContentWriterGoalsUpdate'); ?>
								...
								<div class="card-body">
										...
										<label>Goals List for Content Writer Team</label>
										...
										<td colspan="" style="min-width: 500px!important;text-align:center;">
