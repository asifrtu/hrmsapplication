...
<div class="col-lg-7"> <i style="font-size: 10px;color: white;" class="fas fa-chevron-right"></i><a href="<?php echo base_url() ?>index.php/hrzone/CompanyGoals/CompanyGoalInfo" style="text-decoration:none;"><span class="breadcrumb_text" style="font-size: 15px;color: #fff;"> &nbsp;view&nbsp;&nbsp;</span></a><i style="font-size: 10px;color: white;" class="fas fa-chevron-right"></i><span class="breadcrumb_text" style="font-size: 15px;color: #fff;"> &nbsp;Company Yearly Goals - <span style="font-weight:bold;">edit </span></span></div>
                        </div>
 </div>
					
						

						<?php echo form_open_multipart('hrzone/CompanyGoals/CompanyGoalsUpdate'); ?>
								...
								<div class="card-body">
										...
										<td class="cmPayroll" style="min-width: 450px!important; padding-left: 20px;">
										
										
										<label>Goals List of the Entire Year</label>
										
										
										
										</td>
										<td  class="cmPayroll" style="text-align:center;">
										
										<label>Assignee</label>
										
										</td>
										
										<td  class="cmPayroll" colspan="" style="text-align:center;">
										
										<label>Comment</label>
										
										</td>
										
										<td class="cmPayroll" colspan="" style="min-width: 130px!important;text-align:center;">
										...
										if(!empty($CompanyGoalInfo)):  ?>
									
											<?php	
											
											
											foreach($CompanyGoalInfo as $emp):
										...
										<input type="text" name="goal_points[]" value="<?php if(isset($emp->goal_points)) echo $emp->goal_points;?>" class="titleOne empInput form-control" style="border: 1px solid white;" required>
										
										</td>
										<td >
										
										<input type="text" name="assignee[]" value="<?php if(isset($emp->assignee)) echo $emp->assignee;?>" class="marksOne empInput form-control" style="border: 1px solid white; text-align:left;" >
										
										</td>
										
										<td>
										
										<input type="text" name="goal_comments[]" value="<?php if(isset($emp->goal_comments)) echo $emp->goal_comments;?>" class="KpimarksOne empInput form-control" style="border: 1px solid white; text-align:center;" >
    ...
    $(document).ready(function(){
		 ...
		 $("#add-rowGoal").click(function(){
            ...
            var markup = `<tr id="row_Education_${row}">
										...
										<input type="text" name="goal_points[]" value="" class="titleOne empInput form-control" style="border: 1px solid white;" required>
										
										</td>
										<td>
										
										<input type="text" name="assignee[]" value="" class="marksOne empInput form-control" style="border: 1px solid white; text-align:center;" >
										
										</td>
										
										<td>
										
										<input type="text" name="goal_comments[]" value="" class="KpimarksOne empInput form-control" style="border: 1px solid white; text-align:center;" >
