...
<!-- Add New Package Modal -->
	...
	<form action="<?php echo site_url('hrzone/todo/linkadd');?>" method="post">
...
<!-- Add New Section Modal -->
	...
	<form action="<?php echo site_url('hrzone/todo/sectionadd');?>" method="post">
    ...
    <form action="<?php echo site_url('hrzone/todo/update');?>" method="post">
    ...
    <form action="<?php echo site_url('hrzone/todo/deleteid');?>" method="post">
    ...
    <form action="<?php echo site_url('hrzone/todo/deletesectionid');?>" method="post">
