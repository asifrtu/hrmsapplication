...
#welcomeDashboard{
    ...
    border-bottom: 16px solid #dec9f7;
}
.adminTitle{
	text-align: center;
    color: white;
...
.MAR-3{
    ...
    border-bottom: 5px solid  #dec9f7;
}
.MAR-8{
...
.notifySideBdr {
    border: 1px solid #c6a4ef!important;
    background-color: #ffffff!important;
}
.faviconCustomise{
    border-bottom: 1px solid #dec9f7 !important;
	border:none;
}
...
.form-control:focus {
    color: #343434;
    background-color: #fff;
	border-color: #1C304C54!important;
    outline: 0;
    box-shadow: none;
}
.hola {
...
.empProfileCaption{
        ...
        <div id="content-wrapper bg-gradient-primary" class="container-fluid" style="margin-top:40px;">
            ...
            <div id="content">
				...
				<div class="row" >
                        ...
                        <!-- Content Column -->
                        <div class="col-lg-6 mb-4" style=" padding-left: 0rem!important; margin-bottom: 0rem!important;">
					
						<div class="d-flex" style="outline: 1px solid #cf9ef7;">
					<div class="flex-fill AR2 WallDate">&nbsp;&nbsp;<span style="color:white!important;" ><?php date_default_timezone_set("Asia/Calcutta");  echo date("l, d F Y h:i A") . "\n"; ?></span></div>
					<div class="flex-fill AR2 WallDate">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
					<div class="flex-fill AR2 WallDate">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
					<div class="flex-fill AR2 WallDate">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
					<div class="flex-fill AR2 WallDate">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
					<div class="flex-fill AR2 WallDate">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
					<div class="flex-fill AR2 WallDate">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
                        ...
                        <div class="col-lg-6 mb-4" style="padding-right: 0rem!important; padding-left: 0rem!important; margin-bottom: 0rem!important;">
					
                        <div class="d-flex" style="outline: 1px solid #cf9ef7;margin-left: 10px;">
			...
			<a href="">
            <div class="buttons ">
                <i class="far fa-envelope"><sub class="buttonNotification"></sub></i><p>Message</p>
            </div></a>
        </div>

        <div class="gap col-lg-4 col-md-4">
	 	<a href="<?php base_url('/hrportal/index.php/hrzone/Employee/EmployeeBirthday')?>">
        <div class=" buttons ">
   ...
   //  $query = $this->db->query('employee_birthday', ['birthday_date'=> $date])->result_array();
	  ...
	  ?><?php if($bi > 0){ ?>
        ...
        <div class="gap col-lg-4 col-md-4">
		    <a href="<?=base_url('index.php/hrzone/Attendance/HrAttendance')?>">
            <div class="buttons ">
                <i class="far fa-calendar-alt"></i><p>Calendar</p>
            </div></a>
        </div>
    </div>
        ...
        <div class="container col-md-12 hola">
            ...
            <a href="<?=base_url('index.php/hrzone/Comment/Notification')?>">
			<div class=" buttons">
                <i class="far fa-bell copy_of_bell"></i><p>Notification</p>
            </div></a>
        </div>
        <div class="gap col-lg-4">
		    <a href="">
            <div class=" buttons ">
                <i class="fas fa-bullhorn"></i><p>Announcement</p>
            </div></a>
            </div>
            <div class="gap col-lg-4">
			<a href="<?=base_url('index.php/hrzone/Ticket/EmpTicket')?>">
            <div class=" buttons">
                <i class="far fa-copy"><sub class="buttonNotification"></sub></i> <p>Tickets</p> 
            </div></a>
            </div>
        </div>
        <div class="container col-md-12 hola">
			...
			<a href="">
            <div class=" buttons">
                <i class="far fa-edit copy_of_edit"></i><p>Notes</p>
            </div></a>
        </div>
        <div class="gap col-lg-4">
		    <a href="<?=base_url('index.php/hrzone/CalenderHR')?>">
            <div class=" buttons ">
                <i class="fas fa-tasks gfColor"></i><p>Events</p>
            </div></a>
            </div>
            <div class="gap col-lg-4">
			<a href="">
            <div class=" buttons">
                <i class="fas fa-users gfColor"></i> <p>Meeting</p> 
            </div></a>
            </div>
        </div>
				...
				<div class="col-lg-6" style="border-left: 10px solid #dec9f7;padding-right: 0rem!important; padding-left: 0rem!important;">
							...
							<div class="media-body u-shadow-v18 g-bg-secondary g-pa-30" style="background:#1C304C; padding: 10px; margin-top: 20px;">
    	...
    	?>
						...
						&#127873; &#127880; &#127881; &#127874;	  <?php echo  $this->db->get_where('tbl_user', ['id'=> $row['UserId']])->row()->name;?> &#127874; &#127881; &#127880; &#127873;
							 
														</div>
														<p style="color:white; margin-bottom: 0rem; font-weight:600;   font-size: 13px;color: #343434;">Wish you many happy returns of the day</p>
...
<!-- Modal content-->
	<div class="modal-content" style="margin: 164px 0px 0px -28px;width: 110%!important;">
		<div class="card-header" style="padding:0!important; background-color: #1C304C;">
		<div class="">
	...
	<form class="form-horizontal" action="#">
		...
		<button type="button" class="" id="CommentSubmit" style="text-align:center;width: 96%;margin-left: 12px!important;border-radius: 2px;margin-top: 8px;outline: none;border: 0px;background: #1C304C;padding: 8px;color: white;margin-bottom: 17px;font-size: 14px;">Post</button>		<input type="hidden" name="" id="goal_YearIdHidden"/>
...
<!-- Modal content-->
	...
	<form class="form-horizontal" action="">
        ...
        <button type="button" class="commentData" id="empSeoBtn" style="text-align:center;margin: 0px 14px;margin-bottom: 20px;border: 0px;color: white;background: #1C304C;padding: 5px;border-radius: 3px;">Update</button>
...
<!-- Modal content-->
	...
	<form class="form-horizontal" action="#">
	   ...
	   <div class="form-group">
		   ...
		   <option value=""></option><option value=""></option><option value=""></option><option value=""></option><option value=""></option><option value=""></option><option value=""></option><option value=""></option><option value=""></option><option value=""></option><option value=""></option><option value=""></option><option value=""></option><option value=""></option><option value=""></option><option value=""></option>		   
		   </select>
		   </div>
  ...
  // function updateUserRecord(){
	...
	var ajaxurl = "<?=site_url('hrzone/Comment/UpdateWallComment');?>";
        $.ajax({
            type: "post",
            url: ajaxurl,
            data: {AdComment : AdComment, AdComment_Id : AdComment_Id},
			dataType: "JSON",
			success:function(data){
        ...
        $.ajax({
			...
			${response.dataAnni.map(function(dataAnni, index){
					return(`
							...
							<div class="media g-mb-30 media-comment">
							<div class="media-body u-shadow-v18 g-bg-secondary g-pa-30" style="background: #1C304Cc7; padding: 10px; margin-top: 20px;">
			...
			${response.datadob.map(function(datadob, index){
					return(`
							...
							<div class="media g-mb-30 media-comment">
							<div class="media-body u-shadow-v18 g-bg-secondary g-pa-30" style="background: #f4eaf9;     border: 1px solid #e7d8ee; padding: 10px; margin-top: 20px;">
							<div class="d-flex  g-mb-15" style="JUSTIFY-CONTENT: SPACE-BETWEEN;">
							
							</div>

							<p style=" color: #918e8e; margin-bottom: 0.1rem; margin-top: 8px; font-weight:600;   font-size: 12px;color: #343434;">${datadob.title}</p>
					...
					return(`
							...
							<div class="media-body u-shadow-v18 g-bg-secondary g-pa-30" style="background: #f4eaf9;border: 1px solid #e7d8ee;padding: 10px;padding-bottom: 15px;">
							<div class="d-flex  g-mb-15" style="JUSTIFY-CONTENT: SPACE-BETWEEN;">
							...
							<p style=" color: #918e8e; margin-bottom: 0.1rem;margin-top: 8px ; font-weight:600;font-size: 14px;color: #343434;">${dataEvent.title}</p>
			...
			${response.data.map(function(data, index){
					return(`
							...
							<div class="media-body u-shadow-v18 g-bg-secondary g-pa-30" style="background: #f4eaf9;     border: 1px solid #e7d8ee; padding: 10px; margin-top: 20px;">
							<div class="d-flex g-mb-15" style="JUSTIFY-CONTENT: SPACE-BETWEEN;">
							<h5 class="h5  mb-0" style="font-size:17px; color:#343434; margin-right: 15px;"></h5>
							
							</div>

							<p style=" color: #918e8e; margin-bottom: 0.1rem;     font-size: 12px;color: #343434;">${data.CommentUser}</p>
