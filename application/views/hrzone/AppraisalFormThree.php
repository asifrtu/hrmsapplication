                ...
                <div class="container-fluid">
					...
					<!-- Area Chart -->
						...
						<div class="">	
								...
								<?php echo form_open_multipart('hrzone/Appraisal/AppraisalRanking/'.$UserInfo->id); ?>
							...
							<li class="page-item"><a class="page-link" href="<?=base_url('index.php/hrzone/Appraisal/AppraisalFormTwo/'.$UserInfo->id);?>">Previous</a></li>
							...
							<li class="page-item active"><a class="page-link" href="<?=base_url('index.php/hrzone/Appraisal/AppraisalFormThree/'.$UserInfo->id);?>">3</a></li>
							...
							<li class="page-item"><a class="page-link" href="<?=base_url('index.php/hrzone/Appraisal/AppraisalFormFour/'.$UserInfo->id);?>">Next</a></li>
							</ul>
