					  ...
					  <!-- Area Chart -->
							...
							<div class="col-lg-12">
								<div class="tableHeadAR">
									<h6 class="m-0 font-weight-bold ColorPrimary" style="margin:15px 0;">Yearly Designer Team Goals</h6>
								</div>
							</div>
							</div>
								...
								<div class="col-lg-4" >
								<div class="row">
								<h5 style="text-align:center; margin:auto; color:#6f42c1; font-weight:700;">Yearly Designer Team Goals</h5>
								</div>
								</div>
								<div class="col-lg-4" >
								</div>
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="tableHeadAR">
									<h6 class="m-0 font-weight-bold ColorPrimary" style="margin:15px 0;">Monthly Designer Team Goals</h6>
								</div>
							</div>
							</div>
                    ...
                    <!-- Content Row -->
					  <!-- Area Chart -->
								...
								<div class="p-2 bg-info" style="margin-left:5px;">
									...
									<h5 style="margin-right: 85px; color:#6f42c1; font-weight:700;">Monthly Designer Team Goals</h5>
									</div>
									<div class="table-responsive">
			...
			if(response)
				$("#SeodataTable tbody").html(`${response.data.map(function(data, index){
					...
					<td><div class=" ">
													...
													<li class="tnemp"><a href="#" data-seo="${data.Seo_Id}" class="SeoTeamEdit"><i class="actionFontSize fas fa-edit"></i></a></li>
													</ul>
