...
.sidebar .nav-item .nav-link {
    ...
    width: auto;
        ...
        <ul class="navbar-nav sidebar sidebar-dark" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link SBhover collapsed" href="<?=base_url('index.php/hrzone/Appraisal/FormStatus');?>" >
			 ...
			 <li class="nav-item">
                ...
                <a class="nav-link collapsed" style=" color:yellow!important; border-top: 1px solid #2e2869;" href="<?=base_url('index.php/hrzone/Appraisal/AppraisalForm/');?>" >
