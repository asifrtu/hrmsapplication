...
<div class="col-lg-6"> <i style="font-size: 10px;color: white;" class="fas fa-chevron-right"></i><span class="breadcrumb_text" style=" vertical-align: middle; font-size: 15px;color: #fff;font-weight: 600;"> &nbsp;Employee View KPI</span></div>
<div class="col-lg-5"> 
...
<div class="d-flex sasifb flex-row-reverse ">
									...
									<select class="AttSort empInput form-control" name="Year_Id" id="Year_Id"  id="sel1">
											...
											$selected_text='selected';
											echo "<option $Namyear='".$year->year."' value='".$year->year."'  $selected_text > ".$year->year."</option>";
					...
					<table class="table table-bordered table-sm" id="dataTable" width="100%">
										<thead>
											<tr style="background-color:# !important">
												<td class="cmPayroll" style="min-width: 400px!important; text-align: center;">Monthly KPI Points</td>
										...
										<tfoot>
											...
											<td class="cmPayroll" style="text-align: center;"> ${data.MarksObtained2} </td>
												<td class="cmPayroll" ></td>
											</tr>
										...
										${data.PointsAndMarks.map(function(PointsAndMarksData){
												...
												<td class="fC"><div class=" ">
													...
													<li class="tnemp"><a href="javascript:void(0)" data-KPI="${PointsAndMarksData.employeeKPI_Id}" class="KPIEdit"><i style="color:blue;" class="actionFontSize fas fa-edit"></i></a></li>
													</ul>
