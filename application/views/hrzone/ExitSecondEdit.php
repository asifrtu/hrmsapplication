                ...
                <div class="container-fluid">
					...
					<!-- Area Chart -->
						...
						<div class="">	
								...
								<?php echo form_open_multipart('hrzone/Separation/SecondEdit/'.$User_Id); ?>
							...
							<button type="submit" class="btn btn-default addEmpSubmitBtn">Submit</button>
								...
								<li class="page-item"><a class="page-link" href="<?=base_url('index.php/hrzone/Separation/ExitFormEdit/'.$UserInfo->id);?>">Previous</a></li>
							<li class="page-item " ><a class="page-link" href="<?=base_url('index.php/hrzone/Separation/ExitFormEdit/'.$UserInfo->id);?>">1</a></li>
							<li class="page-item active"><a class="page-link" href="<?=base_url('index.php/hrzone/Separation/ExitSecondEdit/'.$UserInfo->id);?>">2</a></li>
