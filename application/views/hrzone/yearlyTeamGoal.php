                       ...
                       <div class="" >
						...
						<?php echo form_open_multipart('hrzone/CompanyGoals/AddTeamYearlyGoals/'); ?>
								...
								<div class="card-body">
										...
										<label style="color:white;">Team Vise Goal</label>
										</div>
										</div>
										<div class="col-lg-3">
										<div class="form-group" style="margin: 0rem 0rem!important;">
										...
										<label>Points</label>
										<input type="text" name="seogoal_points[]" class="empInput form-control" style="border: 1px solid #858796;" id="email">
										</div>
										</div>
										<div class="col-lg-5">
										<div class="form-group">
										<label>Comment</label>
										<input type="text" name="seogoal_comments[]" class="empInput form-control" style="border: 1px solid #858796;" id="email">
										</div>
										</div>
										</div>
