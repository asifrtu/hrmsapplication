...
<!-- Modal content-->
	<div class="modal-content" style="margin: 100px 0;">
		...
		<div class="row">
		<h6 class="ColorPrimary" style="padding-left: 370px; padding-top: 5px;margin-bottom: 0px;">KPI Edit</h6>
		<button style="margin-left:330px;margin-bottom:5px;" type="button" class="close" data-bs-dismiss="modal">&times;</button>
		</div>
		</div>
