                ...
                <div class="container-fluid">
					...
					<!-- Area Chart -->
						...
						<div class="">	
								...
								<?php echo form_open_multipart('hrzone/Appraisal/AppraisalSix/'); ?>
							...
							<li class="page-item"><a class="page-link" href="<?=base_url('index.php/hrzone/Appraisal/AppraisalFormFive/');?>">Previous</a></li>
							...
							<li class="page-item active"><a class="page-link" href="<?=base_url('index.php/hrzone/Appraisal/AppraisalFormSix/');?>">6</a></li>
							</ul>
