...
<div class="col-lg-7"> <i style="font-size: 10px;color: white;" class="fas fa-chevron-right"></i><span class="breadcrumb_text" style="font-size: 15px;color: #fff;"> &nbsp;Content Writer Team Goals - <span style="font-weight:bold;">view </span></span></div>
									...
									<div class="table-responsive">
										<table class="table table-bordered table-sm" id="SeodataTable" width="100%" cellspacing="0">
											...
											<tr>
												...
												<th class="cmPayroll">Goals List for Content Writer Team</th>
...
function SeoYearlyGoal(YearID){
	var ajaxurl = "<?=site_url('hrzone/CompanyGoals/ContentWriterGoalPointsByYear');?>";
        $.ajax({
			...
			<a href="<?=site_url('hrzone/CompanyGoals/ContentWriterGoalsEdit');?>/${YearempIDData}" style="color: #7481a5; text-decoration: none;">Edit</a>
