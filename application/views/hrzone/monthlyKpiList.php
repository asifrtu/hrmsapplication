...
<div class="col-lg-6"> <i style="font-size: 10px;color: white;" class="fas fa-chevron-right"></i><span class="breadcrumb_text" style=" vertical-align:middle; font-weight:bold; font-size: 15px;color: #fff;"> &nbsp;Monthly KPI LIst</span></div>
...
function MonthlyUserAttendance(YearID, MonthID){
	var ajaxurl = "<?=site_url('hrzone/Kpi/MonthlyKpiList');?>";
        $.ajax({
            type: "get",
            url: ajaxurl,
					...
					<table class="table table-bordered table-sm" id="dataTable" width="100%">
										<thead>
											<tr style="background-color:#dec9f7!important">
												<td class="cmPayroll monthlyListHead" style=" min-width:106px; text-align:center;">Employee ID</td>
												<td class="cmPayroll monthlyListHead text-center" style="padding-left: 10px!important; min-width: 175px;">Employee Name</td>
												<td class="cmPayroll monthlyListHead" style=" min-width: 95px; text-align:center;">KPI Month</td>
												<td class="cmPayroll monthlyListHead" style="min-width: 100px!important; text-align:center;">Total Marks </td>
												<td class="cmPayroll mlist" style=" min-width: 86px; text-align:center;">Marks Allocated</td>
												<td class="cmPayroll mlist" style=" min-width: 105px; text-align:center;">Performance Percentage</td>
												<td class="cmPayroll monthlyListHead" style=" min-width: 175px; text-align:center;">Area of Improvement </td>
										...
										return(`
											<tr style="font-size: 13px;color: #343434;">
												...
												return`
												<td class="fC" style="text-align:center;">${UsercalenderData}</td>
												...
												${data.MarksPercentage.map(function(MarksPercentageData){
												return`
												<td class="fC" style="text-align:center;">${(MarksPercentageData > 0)?MarksPercentageData: "N/A"}</td>
												...
												<td class="fC">
													<div class=" ">
													<ul class="tnUemp">
													<li class="tnemp"><a href="#"><i style="color:grey;" class="Masif fas fa-download"></i></a></li>
