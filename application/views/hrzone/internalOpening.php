...
.current_oppurtunities_div{
    ...
    background-color: white;
        ...
        <div id="content-wrapper bg-gradient-primary" class="my_information col-lg-10" style="background: none;">
            ...
            <span>Internal Openings</span>
        </div>
		<div class=" mx-auto mt-4  referal_div">

<div class="referal_heading">  <h6 class="container">Referal form</h6>  </div>
...
<form action="/action_page.php">
    ...
    <div class="row">
      ...
      <div class="col">
        <input type="text" class="form-control" placeholder="Enter hone" name="pswd">
      </div>
    </div>
    <div class="row">
      <div class="col">
...
<div class="panel-group  mt-3" id="accordion" role="tablist" aria-multiselectable="true">
    <h1 class="current_oppurtunities">Current Oppurtunities</h1>
