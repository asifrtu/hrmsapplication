 ...
 <?php if(!empty($this->session->flashdata('message'))) { ?>
		...
		<?php } ?>
                ...
                <div class="">
                    ...
                    <!-- Content Row -->
					  <!-- Area Chart -->
					<?php echo form_open_multipart('hrzone/CompanyGoals/DesignerGoal/'); ?>							
...
<div class="col-lg-7"> <i style="font-size: 10px;color: white;" class="fas fa-chevron-right"></i><span class="breadcrumb_text" style="font-size: 15px;color: #fff;font-weight: 600;"> &nbsp;Designer Team Goals</span></div>
...
<select class="empInput form-control" name="Year_Id" id="Year_Id" style="border: 1px solid #858796;" id="sel1">
								...
								<div class="card-body pt-4">
										...
										<label>Designer Team Goals of Entire Year</label>
							...
							<button class="btn btn-default addEmpSubmitBtn" id="KPISubmit" type="submit">Create</button>
							</div>
							</div>
						</form>
