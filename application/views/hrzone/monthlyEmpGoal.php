...
<?php include('addGoalSidebar.php'); ?>
<style>
.addEmpSubmitBtn{
	margin: 0px 445px;
                    ...
                    <!-- Content Row -->
					  <!-- Area Chart -->
                        ...
                        <div class="headerAsif ColorSecondaryPre">
                            <h6 class="font-weight-bold ColorPrimary">Employee KPI Goals</h6>
                        </div>
                         <div class="" >
						...
						<?php echo form_open_multipart('hrzone/CompanyGoals/AddKPIMonthlyGoals/'); ?>
								<div class="card-body">
										...
										<div class="col-lg-3">
										<div class="form-group" style="margin: 0rem 0rem!important;">
										<select class="empInput form-control" name="UserId" style="border: 1px solid #858796;" id="sel1">
										...
										<div class="col-lg-2">
										<div class="form-group" style="margin: 0rem 0rem!important;">
										<select class="empInput form-control" name="month_Id" style="border: 1px solid #858796;" id="sel1">
											...
											foreach($GoalMonth as $data){
											echo '<option value="'.$data->month_Id.'">'.$data->month.'</option>';
											 }?>
										...
										<label>Points</label>
										<input type="text" name="kpiGoal_Points[]" class="empInput form-control" style="border: 1px solid #858796;" id="email">
										</div>
										</div>
										<div class="col-lg-1">
										<div class="form-group">
										<label>Marks</label>
										<input type="text" name="kpi_marks[]" class="empInput form-control" style="border: 1px solid #858796;" id="email">
										</div>
										</div>
										<div class="col-lg-5">
										<div class="form-group">
										<label>Comment</label>
										<input type="text" name="kpiGoal_Comments[]" class="empInput form-control" style="border: 1px solid #858796;" id="email">
										</div>
										</div>
										</div>
