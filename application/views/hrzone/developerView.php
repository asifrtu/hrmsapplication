...
<div class="col-lg-7"> <i style="font-size: 10px;color: white;" class="fas fa-chevron-right"></i><span class="breadcrumb_text" style="font-size: 15px;color: #fff;"> &nbsp;Developer Team Goals - <span style="font-weight:bold;">view </span></span></div>
									...
									<div class="table-responsive">
										<table class="table table-bordered table-sm" id="SeodataTable" width="100%" cellspacing="0">
											...
											<tr>
												...
												<th class="cmPayroll">Goals List for Web Developer Team</th>
...
<!-- Modal content-->
	<div class="modal-content" style="margin: 199px 9px 0 80px;  width: 89%!important; ">
		<div class="card-header" style="padding:7px!important; background-color: #1C304C;">
			<div class="">
			<h6 class="ColorPrimary" style="text-align: center;margin-bottom: 0px;">Developer's Goals Edit</h6>
...
function SeoYearlyGoal(YearID){
	var ajaxurl = "<?=site_url('hrzone/CompanyGoals/DeveloperGoalPointsByYear');?>";
        $.ajax({
			...
			<a href="<?=site_url('hrzone/CompanyGoals/DeveloperGoalsEdit');?>/${YearempIDData}" style="color: #7481a5; text-decoration: none;">Edit</a>
