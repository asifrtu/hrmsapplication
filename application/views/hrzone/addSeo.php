 ...
 <?php if(!empty($this->session->flashdata('message'))) { ?>
		...
		<?php } ?>
                ...
                <div class="">
                    ...
                    <!-- Content Row -->
					  <!-- Area Chart -->
							<?php echo form_open_multipart('hrzone/CompanyGoals/SeoGoal/'); ?>	
...
<div class="col-lg-7"> <i style="font-size: 10px;color: white;" class="fas fa-chevron-right"></i><span class="breadcrumb_text" style="font-size: 15px;color: #fff;font-weight: 600;"> &nbsp;SEO Team Goals</span></div>
...
<div class="" style="width: 25%;float: right;margin-right: -30px;">
								...
								<div class="card-body pt-4">
										...
										<label>Seo Team Goals of Entire Year</label>
